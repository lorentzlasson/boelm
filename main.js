...
var author$project$Main$Model = F2(
	function (gameState, tileGrid) {
		return {gameState: gameState, tileGrid: tileGrid};
	});
var author$project$Main$Playing = {$: 'Playing'};
var author$project$Main$GotBoardInit = function (a) {
	return {$: 'GotBoardInit', a: a};
};
var author$project$Main$difficulty = 10;
...
var author$project$Main$percentTrue = function (percent) {
	return A2(
		elm$random$Random$map,
		function (x) {
			return _Utils_cmp(x, percent) < 1;
		},
...
var author$project$Main$randomId = A2(elm_community$random_extra$Random$String$string, 10, elm_community$random_extra$Random$Char$english);
...
var author$project$Main$randomTileInit = function (percent) {
	return A3(
		elm$random$Random$map2,
		elm$core$Tuple$pair,
		author$project$Main$randomId,
		author$project$Main$percentTrue(percent));
};
var author$project$Main$randomTileInitGrid = F2(
	function (percent, size) {
		return A2(
			...
			A2(
				elm$random$Random$list,
				size,
				author$project$Main$randomTileInit(percent)));
	});
...
var author$project$Main$getBoardInit = function (boardSize) {
	return A2(
		elm$random$Random$generate,
		author$project$Main$GotBoardInit,
		A2(author$project$Main$randomTileInitGrid, author$project$Main$difficulty, boardSize));
};
var author$project$Main$init = function (boardSize) {
	return _Utils_Tuple2(
		A2(
			...
			_List_fromArray(
				[_List_Nil])),
		author$project$Main$getBoardInit(boardSize));
};
...
var author$project$Grid$getElem = F2(
	function (grid, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		return A2(
			elm$core$Maybe$andThen,
			elm_community$list_extra$List$Extra$getAt(x),
			A2(elm_community$list_extra$List$Extra$getAt, y, grid));
	});
var author$project$Grid$addCoords = F2(
	function (_n0, _n1) {
		var x1 = _n0.a;
		var y1 = _n0.b;
		var x2 = _n1.a;
...
var author$project$Grid$cartesianPairs = function (possibilities) {
	return A2(
...
var author$project$Grid$neighbourOffsets = function () {
	var coordIncrements = _List_fromArray(
		[-1, 0, 1]);
	var centerCoord = _Utils_Tuple2(0, 0);
	return A2(
		elm_community$list_extra$List$Extra$remove,
		centerCoord,
		author$project$Grid$cartesianPairs(coordIncrements));
}();
var author$project$Grid$getNeighbouringCoords = function (coord) {
	return A2(
		elm$core$List$map,
		author$project$Grid$addCoords(coord),
		author$project$Grid$neighbourOffsets);
};
	...
	function (grid, _n0, occupant) {
		...
		return A2(
			...
			A2(
				elm$core$Maybe$map,
				function (r) {
					return A3(elm_community$list_extra$List$Extra$setAt, y, r, grid);
				},
				A2(
					elm$core$Maybe$map,
...
var author$project$Grid$getCoord = F2(
	function (grid, a) {
		var y = A2(
			elm_community$list_extra$List$Extra$findIndex,
			elm$core$List$member(a),
			grid);
		var row = A2(
		...
		var x = A2(
			elm$core$Maybe$andThen,
			elm_community$list_extra$List$Extra$elemIndex(a),
			row);
		return A3(elm$core$Maybe$map2, elm$core$Tuple$pair, x, y);
	});
...
var author$project$Main$neighbours = function (grid) {
	return A2(
		elm$core$Basics$composeR,
		author$project$Grid$getNeighbouringCoords,
		A2(
			elm$core$Basics$composeR,
			elm$core$List$map(
				author$project$Grid$getElem(grid)),
...
var author$project$Main$neighbouringCoordsBombCount = function (grid) {
	return A2(
		elm$core$Basics$composeR,
		author$project$Main$neighbours(grid),
		elm_community$list_extra$List$Extra$count(
			function ($) {
				return $.bomb;
			}));
};
var author$project$Main$neighbouringBombsCount = F2(
	function (grid, tile) {
		return A2(
			elm$core$Maybe$withDefault,
			0,
			A2(
				elm$core$Maybe$map,
				author$project$Main$neighbouringCoordsBombCount(grid),
				A2(author$project$Grid$getCoord, grid, tile)));
	});
var author$project$Main$clickTile = F2(
	function (coord, grid) {
		var tile = A2(
			elm$core$Maybe$withDefault,
...
var author$project$Main$clickTiles = F2(
	function (grid, coords) {
		return A3(elm$core$List$foldr, author$project$Main$clickTile, grid, coords);
	});
var author$project$Main$gameIsOver = function (state) {
	if (state.$ === 'Playing') {
		return false;
	} else {
		return true;
...
var author$project$Main$initGridToModel = A2(
	elm$core$Basics$composeR,
	author$project$Main$initTileGrid,
	author$project$Main$Model(author$project$Main$Playing));
...
var author$project$Main$hasLost = A2(
	elm$core$Basics$composeR,
...
var author$project$Main$bombsHiddenRestRevealed = function (_n0) {
	var bombs = _n0.a;
	var rest = _n0.b;
	return A2(
		elm$core$List$all,
...
var author$project$Main$hasWon = A2(
	elm$core$Basics$composeR,
	elm$core$List$concat,
	A2(
		elm$core$Basics$composeR,
		...
		author$project$Main$bombsHiddenRestRevealed));
var author$project$Main$gameState = function (grid) {
	return author$project$Main$hasWon(grid) ? author$project$Main$Won : (author$project$Main$hasLost(grid) ? author$project$Main$Lost : author$project$Main$Playing);
};
var author$project$Main$updateGameState = function (model) {
	return _Utils_update(
		model,
		{
			gameState: author$project$Main$gameState(model.tileGrid)
		});
};
var author$project$Main$updateTileGrid = F2(
	function (model, grid) {
		return _Utils_update(
			model,
			{tileGrid: grid});
...
var author$project$Main$viewGameStateText = function (state) {
	switch (state.$) {
		case 'Playing':
			return '';
		case 'Won':
...
var author$project$Main$viewGameState = function (state) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$px(author$project$Main$numberSize * 5))
					]))
			]),
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$text(
				author$project$Main$viewGameStateText(state))
			]));
};
...
var author$project$Main$styleTileBase = _List_fromArray(
	[
		rtfeldman$elm_css$Css$width(
		rtfeldman$elm_css$Css$px(author$project$Main$tileSize)),
...
var author$project$Main$viewTileRow = F2(
	function (grid, tiles) {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$viewTile(grid),
				tiles));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					author$project$Main$viewTileRow(grid),
					grid)),
				author$project$Main$viewGameState(model.gameState)
			]));
};
